 ...
 */}
      ...
      <button className="text-[#D9D9D9] text-base leading-7  text-left font-normal" variant="link">Login</button>
      <button href="#" className="border rounded text-black bg-[#FAFAFA] px-4 py-1">
...
<path d="M4 12H20" stroke="#D9D9D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M4 6H20" stroke="#D9D9D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M4 18H20" stroke="#D9D9D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
      ...
      <SheetContent>
        ...
        <ul className="flex-col items-center justify-center content-center gap-8">
            <li><Link href="#">Docs</Link></li>
            <li><Link href="#">Pricing</Link></li>
            <li><Link href="#">Status</Link></li>
            <li><Link href="#">FAQs</Link></li>
